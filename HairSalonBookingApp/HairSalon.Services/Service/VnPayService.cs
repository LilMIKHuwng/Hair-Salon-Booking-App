...
namespace HairSalon.Services.Service
{
    public class VnPayService : IVnPayService
    {
        ...
        public async Task<string> CreatePaymentUrl(PaymentRequestModelView model, HttpContext context)
        {
        ...
        public async Task<string> ExecuteDepositToWallet(Guid userId, double amount)
        {
